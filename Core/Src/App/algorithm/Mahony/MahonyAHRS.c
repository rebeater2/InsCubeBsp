...
volatile float q0 = 1.0f, q1 = 0.0f,
    q2 = 0.0f,                             // quaternion of sensor frame relative to auxiliary frame
...
void MahonyAHRSGetEuler(float euler[3]) {
    ...
    euler[1] = asinf(2 * (q0 * q2 - q1 * q3));
    euler[2] = atan2f(2 * (q0 * q3 + q1 * q2), 1 - (q2 * q2 + q3 * q3));
}
